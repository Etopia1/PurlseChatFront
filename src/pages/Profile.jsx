            ...
            <div className="max-w-2xl mx-auto p-8 py-8">
                <div className="bg-base-300 rounded-xl p-4 space-y-8">
                    <div className="text-center">
                        ...
                        <p className="mt-0">Your profile information</p>
                    </div>
                    ...
                    <div className="flex flex-col items-center gap-4">
                        <div className="relative">
                            <img
                                src={selectedImg || authUser.profilePic || "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png"}
                                alt="Profile"
